...
export default function DashboardOfficeNavBridge() {
  ...
  useEffect(() => {
    ...
    setContainer(document.querySelector<HTMLElement>('.premium-sidebar'));
  }, [pathname]);
